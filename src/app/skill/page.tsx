  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      <PageIntro
        ...
        lede="手册讲的是制度。Skill 逼模型对着 diff 手把手带读：这几行机器在干什么、为什么这样写、删掉会怎样，再压成 90 秒口播。只列「加了什么功能」不算完成。讲不清的行必须标红。写不出来就写不准合。"
      />
      ...
      <section className="mt-12">
        ...
        <ol className="mt-6 divide-y divide-border border-y border-border">
          {[
            ...
            [
              "手把手带读",
              "每个行为 hunk 贴原码。四问：干什么、为什么这样写、删掉会怎样、和前后怎么接。禁止「其余类似」。",
            ],
...
## 90 秒复述
## 行为变化
## 关注点 + 手把手带读（贴原码 / 干什么 / 为什么这样写 / 删掉会怎样）
## 难懂清单
## 风险（八行表 + 怎么查）
## 出问题怎么排
## 怎么证明它对
